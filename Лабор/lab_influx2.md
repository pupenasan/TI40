...
# Лабораторна робота №6. Influx DB. Робота з запитами на мові flux (Частина 2)
...
рис.1. Data Explorer - конструктор запитів
...
рис.3. Фрагмент представлення таблиць з номером таблиці 
