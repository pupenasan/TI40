...
# Лабораторна робота №3. Протоколи IoT: Використання WEB API та Web-сокетів
...
Для тестування API Ви можете користуватися будь якою утилітою, наприклад <https://reqbin.com/> (у [відео](https://youtu.be/v9aAontbP88) використовується <https://apitester.com> який застарів)
...
## 4. Використання WEB-сокетів для з’єднання мобільного застосунку та Node-RED  
...
## 5. Доробка застосунку в Node-RED для фіксації штрих-кодів в базі даних та виведення по ним інформації.  
...
9. Як засоби використовувалися в лабораторній роботі для мобільних застосунків при     роботі з MQTT?
10. Розкажіть про основи роботи протоколу HTTP.
11. Які інструменти використовувалися в лабораторній роботі для роботи з HTTP?
12. Розкажіть про призначення заголовків HTTP. Які заголовки використані в лабораторній     роботі?
13. Які методи HTTP і для чого використовувалися в лабораторній роботі?
