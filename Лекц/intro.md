...
2. Що вважається початком Інтернету речей? Як Ви думаєте чому?

3. Що таке промисловий Інтернет речей? У чому його особливість?

4. Що входить до екосистеми IoT?

5. Що входить до екосистеми Інтернету речей?

6. Розкажіть про основні елементи архітектури Інтернету речей.

7. Розкажіть про особливості використання датчиків та виконавчих механізмів в IoT.

8. Розкажіть про особливості передачі даних в IoT.

9. Розкажіть про особливості маршрутизації в IoT.

10. Що таке туманні та граничні обчислення?

11. У чому проблема аналізу даних за місцем збору?

12. Чому в системах IoT та IIoT ставляться особливі вимоги щодо кібербезпеки?
