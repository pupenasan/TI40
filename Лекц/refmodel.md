...
Рис 10.1. Еталонна модель архітектури Industrie 4.0
...
Права вісь моделі RAMI 4.0 – «Ієрархічні рівні» («Hierarchy levels») – забезпечує відображення активу на конкретну роль у виробництві. Ієрархічні рівні RAMI 4.0 в рамках одного підприємства базуються на ієрархії технологічного устатковання на основі ролей, означених стандартом IEC-62264 та відповідно фізичній моделі технологічного устатковання, означеної в IEC-61512 (див. рис. 10.2). Але ця модель в деякій мірі є розширеною, що, до речі, дозволяється цими стандартами.

![](refmodel/10_2.png)  

Рис 10.2. Ієрархічні рівні еталонної моделі архітектури Industrie 4.0

Виділені зеленим кольором елементи на рисунку 10.2 присутні серед ієрархічних рівнів RAMI 4.0. Поняття «Підприємства» та «Робочих центрів» відображені в тому ж функціональному сенсі, що й в IEC-62264. З метою застосування концепції Industrie 4.0 на більшій кількості виробничих секторів «модулі технологічного устатковання» та «модулі керування» були замінені поняттями «Станція» та «Пристрій керування», які використовуються в ISA-TR88.00.02-2015 «Machine and Unit States - An implementation example ISA88». Можливо використання саме такої ієрархії зумовлено розвитком на території Німеччини дискретного виробництва, а саме машинобудування. 
...
Але кожен із зацікавлених сторін у ланцюжку вартості використовує різні типи моделей транспортера (рис. 10.3): 
...
\- постачальник сервісів обробки та аналізу даних аналізує рівень забруднення [5].

![](refmodel/10_3.png)  

Рис 10.3. Розгляд транспортера з точки зору життєвого циклу та ієрархічного рівня 
...
1. Що таке модель RAMI4.0?

2. Які стандарти лягли в основу моделі RAMI4.0?

3. Що таке актив у розумінні RAMI4.0?

4. Що таке кіберфізичний компонент RAMI4.0?

5. Розкажіть про розгляд активів з точки зору їх життєвого циклу в RAMI4.0.

6. Розкажіть про ієрархічні рівні в RAMI4.0. Як вона розширена порівняно з стандартами, на які модель спирається?

7. Розкажіть про рівень "Продукту" в ієрархії  RAMI4.0.

8. Прокоментуйте вісь життєвого циклу RAMI4.0.

9. На прикладі транспортера прокоментуйте використання різних типів моделей та даних компонента RAMI4.0 протягом його життєвого циклу.
